...
training_time_cpu = train_model(model_cpu, trainloader, 'cpu')
...
print(f"CPU Training time: {training_time_cpu} seconds")
print(f"CPU Inference time: {inference_time_cpu} seconds")
